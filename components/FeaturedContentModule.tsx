    ...
    <section className="space-y-6">
      {trendingBanner ? (
        <div className="glass-panel overflow-hidden rounded-[28px] border border-[var(--border-color)] p-6">
          <p className="editorial-kicker">On readers&apos; minds</p>
          ...
          <p className="theme-meta mt-3 max-w-3xl text-sm leading-6">
            {trendingBanner.description || "The story readers are carrying with them right now."}
          </p>
        </div>
      ) : null}
      ...
      <div>
        <div className="mb-5">
          <p className="editorial-kicker">Featured stories</p>
      ...
      <div className="glass-panel rounded-[28px] border border-[var(--border-color)] p-6">
        <div className="mb-5 flex items-center justify-between gap-4">
          <div>
            <p className="editorial-kicker">Editor&apos;s picks</p>
            <h2 className="font-heading theme-heading mt-2 text-3xl font-semibold">
              A quieter kind of favorite
            </h2>
          </div>
        </div>
