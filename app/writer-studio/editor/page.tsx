...
export default async function WriterStudioEditorPage({
  searchParams,
}: {
  searchParams?: {
    draft?: string;
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <Link href="/writer-studio/new-episode" className="story-button-secondary">
          Back to New Episode
        </Link>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="theme-panel rounded-[22px] border border-[var(--border-color)] p-4">
                  ...
                  <p className="theme-body mt-3 text-sm leading-6">
                    {isBlank ? "Empty document route" : `Loaded draft ${draft.id}`}
                  </p>
                </div>
                <div className="theme-panel rounded-[22px] border border-[var(--border-color)] p-4">
